                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-[#e7e8eb] rounded-md text-[14px] focus:outline-none focus:border-[#007bff]"
                    />
                  </div>
                  <div>
                    <label className="block text-[14px] font-medium text-[#212529] mb-1">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 border border-[#e7e8eb] rounded-md text-[14px] focus:outline-none focus:border-[#007bff] bg-white"
                    >
              ...
              <div className="flex-1 space-y-4">
                ...
                <div>
                  <textarea
                    ...
                    className="w-full px-3 py-2 border border-[#e7e8eb] rounded-md text-[14px] text-[#495057] italic focus:outline-none focus:border-[#007bff] resize-none leading-relaxed"
                  />
                </div>
              </div>
            </div>
