          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-8">
            <div className="rounded-lg border border-[#e2e4e5] p-8">
              <div className="rounded-lg border border-[#e2e4e5] p-8 space-y-8">
                ...
                {/* Pharmacist License Upload */}
                <FileUploadSection
                  title="Upload Pharmacist License (Front & Back)"
                  onChange={(file) => setFiles({...files, pharmacistLicense: file})}
                />

                {/* Pharmacy License Upload */}
                <FileUploadSection
                  title="Upload Pharmacy License (Front & Back)"
                  onChange={(file) => setFiles({...files, pharmacyLicense: file})}
                />

                {/* Pharmacy Image Upload */}
                <FileUploadSection
                  title="Upload Pharmacy Image (displayed to patients)"
                  onChange={(file) => setFiles({...files, pharmacyImage: file})}
                />
