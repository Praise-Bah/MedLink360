...
export function VerificationDoctorForm() {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    console.log("Doctor verification submitted", files)
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-8">
            <div className="rounded-lg border border-[#e2e4e5] p-8">
              <div className="rounded-lg border border-[#e2e4e5] p-8 space-y-8">
                ...
                <FileUploadSection
                  title="Upload Medical License/Permit (Front & Back)"
                  onChange={(file) => setFiles({...files, license: file})}
                />

                {/* Medical Degree Upload */}
                <FileUploadSection
                  title="Upload Medical degree certificates"
                  onChange={(file) => setFiles({...files, degree: file})}
                />
